...
| D-03 | Seeded LSH is named but not defined. | Approve projection distribution and dimensions, seed-to-generator mapping, sign/tie rule, numeric precision, bit order, and compatibility/version policy. |
